...
```
raftmage/
  internal/raft/      Raft consensus core: Node, roles, RequestVote/AppendEntries/InstallSnapshot RPCs, election, heartbeats, Propose, log compaction, cluster membership changes, the Transport/Storage interfaces
